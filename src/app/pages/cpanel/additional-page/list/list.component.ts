...
import { AdditionalPageViewModel , GetAdditionalPageList } from 'src/app/models/shared/additional-page';
...
@Component({
    selector: "app-additional-page-list",
...
export class AppAdditionalPageListComponent implements OnInit {
    constructor(
    ...
    options : GetAdditionalPageList = new GetAdditionalPageList();    
    checked = false;
    indeterminate = false;
    listOfCurrentPageData: readonly AdditionalPageViewModel[] = [];
    listOfData: readonly AdditionalPageViewModel[] = [];
    ...
    onCurrentPageDataChange($event: readonly AdditionalPageViewModel[]): void {
    ...
    load(options : GetAdditionalPageList | null){
      this.isLoading=true;
    ...
    isRowDeleting(item:AdditionalPageViewModel){
    ...
    toggleEnabled(item:AdditionalPageViewModel){
    ...
    toggleEnabledLoading(item:AdditionalPageViewModel){
    ...
    create(){
      this.service.add().subscribe({
        next: (v) => {
          this.router.navigate(['/cpanel/additional-page/'+v.data], { relativeTo: this.route });
        },
        error: (e) => {
          console.error(e)
          this.toaster.toast(MessageType.error,MSG.additionalPage.create.error);
        },
        complete: () => {}
    });
    }
