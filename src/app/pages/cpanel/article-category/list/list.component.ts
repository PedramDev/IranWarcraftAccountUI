...
import { ArticleCategoryViewModel , GetArticleCategoryList } from 'src/app/models/blog/article-category';
...
export class AppArticleCategoryListComponent implements OnInit {
    constructor(
    ...
    options : GetArticleCategoryList = new GetArticleCategoryList();    
    checked = false;
    indeterminate = false;
    listOfCurrentPageData: readonly ArticleCategoryViewModel[] = [];
    listOfData: readonly ArticleCategoryViewModel[] = [];
    ...
    onCurrentPageDataChange($event: readonly ArticleCategoryViewModel[]): void {
    ...
    load(options : GetArticleCategoryList | null){
      this.isLoading=true;
    ...
    isRowDeleting(item:ArticleCategoryViewModel){
    ...
    toggleEnabled(item:ArticleCategoryViewModel){
    ...
    toggleEnabledLoading(item:ArticleCategoryViewModel){
    ...
    create(){
      this.service.add().subscribe({
        next: (v) => {
          this.router.navigate(['/cpanel/article-category/'+v.data], { relativeTo: this.route });
        },
        error: (e) => {
          console.error(e)
